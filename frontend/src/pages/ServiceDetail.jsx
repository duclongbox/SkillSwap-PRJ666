...
/* Assuming you're passing in the service data as props or fetching it */
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-3xl mx-auto py-10 px-4">
        <section className="bg-white p-8 rounded-md shadow-sm mb-10">
          ...
          <p className="text-sm text-gray-700 mb-2">
            <strong>Offered by:</strong> {service.seller}
          </p>
          <p className="text-sm text-gray-700 mb-6">
            <strong>Exchange using:</strong> {service.skillsRequired.join(', ')}
          </p>
